...
const APP_LOGO = {
  ...
  linkIos: {
    en: 'https://apps.apple.com/eg/app/bayut-egypt/id6736895230',
    ar: 'https://apps.apple.com/eg/app/bayut-egypt/id6736895230',
  },
  linkPlayStore: {
    en: 'https://play.google.com/store/apps/details?id=com.bayut.bayuteg',
    ar: 'https://play.google.com/store/apps/details?id=com.bayut.bayuteg',
  },
  getLogoText: () => ({
    en: 'Egypt',
    ar: 'مصر',
...
const appConstants = Object.freeze({
  ...
  SHORT_TITLE: 'EG',
  COUNTRY_CODE: 'EG',
  PHONE_REGEX: /^(\+20|20|0020)?\d{10}$/,
  PHONE_CODE: '+20',
  CURRENCY: 'EGP',
  CURRENCY_SYMBOL: (str) => (str ? `${t('EGP')}${str}` : t('EGP')),
  LINK_TITLE: 'bayut.eg',
